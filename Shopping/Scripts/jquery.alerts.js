...
(function($) {
	...
	var Customtitle = 'ATA Store';
	// Shortuct functions
	jAlert = function(message, callback) {
	    $.alerts.alert(message, Customtitle, callback);
	}
	...
	jConfirm = function (message, callback) {
	    $.alerts.confirm(message, Customtitle, callback);
	};
	...
	jPrompt = function(message, value, callback) {
	    $.alerts.prompt(message, value, Customtitle, callback);
	};
